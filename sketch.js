...
function showArrows(index, arrows) {
  ...
  if (
    ...
    if (!arrows[index].isRemoved) {
      //Modified the function name from "removed" to "remove"
...
//For playerArrowCollision, you reduce the computer's life
//Since player arrows attack the computer
function handlePlayerArrowCollision() {
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    //Only 1 if statement is required here
    if (
      ...
      //Changed all player objects to computer objects to maje the logic correct
...
//This function checks if the computer arrows collide with the player and reduces the player's lives
